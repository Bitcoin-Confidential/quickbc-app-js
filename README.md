...
All app source code and assets copyright © 2014-2019 by QuickBC. All rights reserved.


## Downloads

Download the latest version from our website at [bitcoinconfidential.com](https://www.bitcoinconfidential.com) or from the Releases tab.
...
Please don't use the Issues tracker for general support or inquiries. You can also [contact us](https://bitcoinconfidential.com/support) directly.
...
If you have an improvement to the codebase and would like to have your code shipped in the production QuickBC app, please submit a [pull request](https://help.github.com/articles/about-pull-requests/), even if it's still a WIP. We try to credit all contributors in app release notes.
...
The maintainer enjoys collaborating with volunteer contributors to the QuickBC apps over Discord, so PR'd submissions do not have to be at all complete or perfect on their first submission. (To submit a draft PR for review, simply mark it as '[DO NOT MERGE]')
...
QuickBC Donation Address (XMR): 48yi8KBxh7fdZzwnX2kFCGALRcN1sNjwBHDfd5i9WLAWKs7G9rVbXNnbJTqZhhZCiudVtaMJKrXxmBeBR9kggBXr8X7PxPT

Proceeds from donations are used to fund development on the QuickBC back-end server (a performant version of which we soon™ plan to open-source for anyone to run their own server at home). Any remaining funds will go towards product (app UI) R&D, and hosting costs.
